...
public class Field {
    ...
    public static class BlueHub {
        ...
        public static final Translation3d innerCenter =
                new Translation3d(CENTER_X, CENTER_Y, INNER_OPENING_HEIGHT);
        public static final Translation2d nearLeftCorner =
                new Translation2d(TAG_26_X, CENTER_Y + WIDTH / 2.0);
        public static final Translation2d nearRightCorner =
                new Translation2d(TAG_26_X, CENTER_Y - WIDTH / 2.0);
        public static final Translation2d farLeftCorner =
                new Translation2d(TAG_26_X + WIDTH, CENTER_Y + WIDTH / 2.0);
    ...
    public static class RightBlueBump {
        ...
        public static final Translation2d nearRightCorner =
                new Translation2d(
                        BlueHub.CENTER_X - BlueBumps.DEPTH / 2.0, BlueTrench.OPENING_WIDTH);
    ...
    public static class RightBlueTrench {
        ...
        public static final Translation3d openingTopLeft =
                new Translation3d(
                        BlueHub.CENTER_X, BlueTrench.OPENING_WIDTH, BlueTrench.OPENING_HEIGHT);

        public static final Translation3d openingTopRight =
                new Translation3d(BlueHub.CENTER_X, 0.0, BlueTrench.OPENING_HEIGHT);
    }
    ...
    @Getter public static final Translation3d redHubCenter = blueToRed(BlueHub.topCenter); // new
    // Translation3d(
    // Units.inchesToMeters(469.11),
    // Units.inchesToMeters(158.84),
    // Units.inchesToMeters(72));

    @Getter private static final double APRIL_TAG_WIDTH = Units.inchesToMeters(6.50);
