...
public class IntakeArm extends SubsystemBase {
    ...
    private final TalonFX intakeArmMotor =
            new TalonFX(Constants.CanIdCanivore.INTAKE_ARM, Constants.CanIdCanivore.CARNIVORE);
    ...
    private void configureMotor() {
        ...
        final TorqueCurrentConfigs torqueDeadband =
                new TorqueCurrentConfigs().withTorqueNeutralDeadband(6.5);
    ...
    public void setIntakePosition(final double pos) {
        this.intakeArmMotor.setControl(this.motionMagic.withPosition(pos));
    }

    public void setSlowIntakePosition(final double pos) {
        this.intakeArmMotor.setControl(this.slowMotionMagic.withPosition(pos));
    }

    public void setMidIntakePosition(final double pos) {
        this.intakeArmMotor.setControl(this.midMotionMagic.withPosition(pos));
    }
